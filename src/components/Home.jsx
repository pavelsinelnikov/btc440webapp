      ...
      <main>
        <Container>
          ...
          <Content
            ...
            alttxt="Yahoo logo"
            content="One common security risk people face daily is having weak and common passwords. This is significant because weak passwords can easily be compromised. Over 83 percent of people surveyed use one password for multiple sites (Zane, 2018). Using weak and repeated passwords on different websites puts you at great risks for attacks to your account. If an attacker gains access to one account, they can potentially gain access to the rest because of the common password you use across multiple sites."
          />
